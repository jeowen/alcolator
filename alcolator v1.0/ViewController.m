...
//    [self.tabBarItem setBadgeValue:[NSString stringWithFormat:@"%d", (int) sender.value]];
     ...
     [self.tabBarItem setBadgeValue:[NSString stringWithFormat:@"%@", [self getNumberOfGlasses]  ]];
   }
...
- (NSString *)getNumberOfGlasses{
    ...
    // generate the result text, and display it on tab item
    ...
    // NSString *resultText = [NSString stringWithFormat:NSLocalizedString(@"%.1f", nil), numberOfWineGlassesForEquivalentAlcoholAmount];
    NSString *resultText = [NSString stringWithFormat:NSLocalizedString(@"%d", nil), wholeNumber];
    return resultText;
}
@end
