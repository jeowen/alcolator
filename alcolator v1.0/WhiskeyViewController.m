...
//  alcolator v1.0
//
//  Created by Jason Owen on 1/26/16.
...
- (NSString *)getNumberOfGlasses{
    ...
    NSString *resultText = [NSString stringWithFormat:NSLocalizedString(@"%.1f", nil), numberOfWhiskeyGlassesForEquivalentAlcoholAmount];
    return resultText;
}
@end
